package("spdlog")
    ...
    add_configs("header_only",  {description = "Use header only", default = false, type = "boolean"})
    add_configs("fmt_external", {description = "Use external fmt library instead of bundled", default = true, type = "boolean"})
    ...
    add_configs("wchar",        {description = "Build with wchar_t (Windows only)", default = false, type = "boolean"})
